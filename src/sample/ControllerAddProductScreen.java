...
public class ControllerAddProductScreen {

    public void addProductScreenAddButtonPushed(ActionEvent event) throws Exception{

        //TODO
        // Add code here for adding the part to the associated parts
    }

    public void addProductScreenRemoveAssociatedPartButtonPushed(ActionEvent event) throws Exception{

        //TODO
        // Add code here for removing the part from the associated parts
    }

    public void addProductScreenSaveButtonPushed(ActionEvent event) throws Exception{
    ...
    public void addProductScreenCancelButtonPushed(ActionEvent event) throws Exception{
