...
public class ControllerModifyProductScreen {

    public void modifyProductScreenAddButtonPushed(ActionEvent event) throws Exception{

        //TODO
        // Add code here for adding the part to the associated parts
    }

    public void modifyProductScreenRemoveAssociatedPartButtonPushed(ActionEvent event) throws Exception{

        //TODO
        // Add code here for removing the part from the associated parts
    }

    public void modifyProductScreenSaveButtonPushed(ActionEvent event) throws Exception{
    ...
    public void modifyProductScreenCancelButtonPushed(ActionEvent event) throws Exception{
